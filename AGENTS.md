...
```
- Add support for XYZ ([#123](https://github.com/cbrnr/pybvrf/pull/123) by [Your Name](https://github.com/yourname))
```

## Commit messages

- Use the imperative mood and start with a capital letter (e.g., `Fix crash when loading specific files`).
